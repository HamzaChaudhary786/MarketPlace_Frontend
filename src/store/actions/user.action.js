...
export const deleteUserAction = (id) => {
    return async (dispatch) => {
        ...
        try {
                ...
                const response = await axios.delete(`${API_URL}/api/user/delete/${id}`,{withCredentials: true});
...
export const signOutAction = () => {
    return async (dispatch) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/auth/signout`,{withCredentials: true});
...
export const UserListingsAction = (id) => {
    ...
    return async (dispatch) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/user/listings/${id}`,{withCredentials: true});
...
export const singleListingAction = (id) => {
    ...
    return async (dispatch) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/listing/get/${id}`,{withCredentials: true});
...
export const ContactAction = (id) => {
    ...
    return async (dispatch) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/user/${id}`,{withCredentials: true});
...
export const getSearchDataAction = (searchTerm) => {
    ...
    return async (dispatch) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/listing/get?${searchTerm}`,{withCredentials: true});
